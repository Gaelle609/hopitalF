<template>
  ...
  <div class="card border-0  p-4" id="receipt">
    ...
    <div class="d-flex justify-content-between">
      ...
      <div class="d-flex align-items-start receipt-content">
        ...
        <div>
          <small>
            ...
            <p class="mb-0 fw-bold small text-muted">Situé près de la mosquée au carrefour caisse</p>
            <p class="mb-0 fw-bold small text-muted">Contact: +237699637173</p>
          </small>
        </div>
      </div>
      ...
      <div class="text-end">
         <p class="mb-4"></p>
        <p class="mb-0 small text-muted"><b>Reçu N° :</b> {{ payment.code}}</p>
        <p class="mb-0 small text-muted"><b>Date :</b> {{ formattedDate }}</p>
      </div>
    </div>
  <!-- Titre reçu -->
      <div class="flex-grow-1 text-center bg-light py-2 my-3">
        <h3 class="mb-0 fw-bold text-decoration-underline text-muted">REÇU</h3>
      </div>
    <!-- Corps du reçu -->
