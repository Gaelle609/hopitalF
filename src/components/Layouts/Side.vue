            ...
            <div class="adminuiux-sidebar-inner">
                ...
                <ul class="nav flex-column menu-active-line my-3">
                    <li class="nav-item"><a href="clinic-dashboard.html" class="nav-link"><i class="menu-icon"
                                data-feather="grid"></i> <span class="menu-name">Tableau de Bord</span></a></li>
                    <li class="nav-item dropdown"><a href="javascrit:void(0)" class="nav-link dropdown-toggle"
                            data-bs-toggle="dropdown"><i class="menu-icon" data-feather="users"></i> <span
                                class="menu-name">Patients</span></a>
                    ...
                    <li class="nav-item dropdown"><a href="javascrit:void(0)" class="nav-link dropdown-toggle"
                        ...
                        <div class="dropdown-menu">
                            <div class="nav-item"><a href="clinic-patients-documents.html" class="nav-link"><i
                                        class="menu-icon" data-feather="users"></i> <span class="menu-name">Dossier Medicale</span></a></div>
                            <div class="nav-item"><a href="clinic-staff-documents.html" class="nav-link"><i
                                        class="menu-icon" data-feather="briefcase"></i> <span class="menu-name">
                                        Documents Staff</span></a></div>
                        </div>
                    </li>
                   
                    <li class="nav-item"><a href="clinic-personalization.html" class="nav-link"><i
                                class="menu-icon bi bi-palette h6"></i> <span class="menu-name">Personaliser L'interface
                                ❤️</span></a></li>
                        ...
                        <div class="card-body p-2">
                            <div class="row gx-2">
                                <div class="col-12 d-flex justify-content-between"><a href="clinic-myprofile.html"
                                        class="btn btn-square btn-link"><span class="position-relative"><i
