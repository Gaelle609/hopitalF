    ...
    <nav class="navbar navbar-expand-lg fixed-top">
      <div class="container-fluid">
        ...
        <router-link :to="{ name: 'HomePage' }" class="navbar-brand">
          ...
          />
          <div class="">
            <span class="company-name text-uppercase h4"><b>We</b>Care</span>
            <!-- <p class="company-tagline">AdminUIUX HTML template</p> -->
          </div>
        </router-link>
        <div
          class="collapse navbar-collapse right-in-device"
          id="header-navbar"
        >
        ...
        <div class="ms-auto">
          ...
          <button
            class="btn btn-link btn-square btn-icon btn-link-header d-inline-block d-xxl-none"
            type="button"
            onclick="openSearch()"
          >
            <i data-feather="search"></i>
          ...
          <div class="dropdown d-none d-sm-inline-block">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li>
                <a class="dropdown-item active" data-value="EN">EN - English</a>
              </li>
          ...
          <div class="dropdown d-inline-block">
            <a
              class="dropdown-toggle btn btn-link btn-link-header style-none"
              id="userprofiledd"
              data-bs-toggle="dropdown"
              aria-expanded="false"
              role="button"
            >
              <div class="row gx-0 d-inline-flex">
                ...
                <div class="col align-self-center d-none d-xl-block px-2">
                  <span class="mb-0">{{ user.first_name }}</span>
                </div>
              </div>
            </a>
            <div
            ...
            >
              <div
                class="bg-theme-1-space rounded py-3 mb-3 dropdown-dontclose"
              >
                <div class="row gx-0">
              ...
              <div class="px-2">
                ...
                <div>
                  <a class="dropdown-item" href="clinic-settings.html"
                    ><i
                      data-feather="settings"
                      class="avatar avatar-18 me-1"
                    ></i>
    ...
    <div class="adminuiux-search-full">
      <div class="row gx-2 align-items-center">
        ...
        <div class="col-auto">
          <div class="dropdown input-group-text border-0 p-0">
            <button
              class="dropdown-toggle btn btn-link no-caret"
              type="button"
              id="searchfilter2"
              data-bs-toggle="dropdown"
              aria-expanded="false"
